										...
										switch ($portfoliovideotype){
											case "youtube": ?>
												<?php if($lightbox_video_single_project == "yes"){ ?>
													...
													?>
													<a class="lightbox_single_portfolio video_in_lightbox" title="<?php echo $video_title; ?>" href="//www.youtube.com/watch?feature=player_embedded&v=<?php echo $vidID; ?>" rel="prettyPhoto[single_pretty_photo]">
											...
											case "vimeo": ?>
												<?php if($lightbox_video_single_project == "yes"){ ?>
													...
													?>
													<a class="lightbox_single_portfolio video_in_lightbox" title="<?php echo $video_title; ?>" href="//vimeo.com/<?php echo $vidID; ?>" rel="prettyPhoto[single_pretty_photo]">
														<i class="fa fa-play"></i>
														<img width="100%" src="<?php echo $thumbnail; ?>"></img>
													</a>
												<?php } else { ?>
					...
					foreach($portfolio_images as $portfolio_image){
						...
						<?php }else{ ?>
							...
							switch ($portfoliovideotype){
								case "youtube": ?>
									<?php if($lightbox_single_project == "yes"){ ?>
										<a class="lightbox_single_portfolio <?php echo $columns_number; ?>" title="<?php echo $portfolio_image['portfoliotitle'];  ?>" href="//www.youtube.com/watch?feature=player_embedded&v=<?php echo $portfolio_image['portfoliovideoid']; ?>" rel="prettyPhoto[single_pretty_photo]">
											<span class="gallery_text_holder"><span class="gallery_text_inner"><h6><?php echo $portfolio_image['portfoliotitle'];  ?></h6></span></span>
