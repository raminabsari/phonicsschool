            ...
            <div class="container">
                ...
                <div class="container_inner default_template_holder">
                    <div class="page_not_found">
                        ...
                        <p><a class="qbutton with-shadow" href="<?php echo home_url(); ?>/"><?php if($qode_options_proya['404_backlabel'] != ""): echo $qode_options_proya['404_backlabel']; else: ?> <?php _e('Back to homepage', 'qode'); ?> <?php endif;?></a>
                        &nbsp;&nbsp;<a class="qbutton with-shadow" href="/contact">Get in touch</a></p>
                        <div class="separator  transparent center  " style="margin-top:35px;"></div>
                    </div>
                </div>
                <?php if(isset($qode_options_proya['overlapping_content']) && $qode_options_proya['overlapping_content'] == 'yes') {?>
